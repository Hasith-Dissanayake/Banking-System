...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10 main-content p-4">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <a href="view_deposits" class="btn btn-banking-primary">
                        <i class="fas fa-plus me-2"></i>View Deposits
                ...
                <div class="card-body">
                    ...
                    <c:choose>
                        <c:when test="${empty account}">
                            ...
                            <form action="${pageContext.request.contextPath}/admin/deposit" method="post" class="row g-3 needs-validation" novalidate>
