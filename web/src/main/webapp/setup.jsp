...
<html>
<head>
    <title>Setup Super Admin - Banking System</title>
                ...
                <div class="card card-banking mt-5">
                    <div class="card-header text-center">
                        <h3 class="card-title mb-0">
                            <i class="fas fa-user-shield me-2"></i>Setup Super Admin
                        </h3>
                    </div>
                    <div class="card-body">
                        <!-- Error Messages -->
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Welcome to the Banking System!</strong><br>
                            This is the initial setup page. Please create the first Super Admin account to get started.
                        </div>
