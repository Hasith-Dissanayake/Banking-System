...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10 main-content p-4">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <a href="view_transfers" class="btn btn-banking-primary">
                ...
                <div class="card-body">
                    ...
                    <c:choose>
                        <c:when test="${empty fromAccount || empty toAccount}">
                            ...
                            <form action="${pageContext.request.contextPath}/admin/transfer" method="post" class="row g-3 needs-validation" novalidate>
